;   From https://github.com/Zeda/Z80-Optimized-Routines/blob/master/math/multiplication/mul16.z80
;
...
;   min: 214cc  (DE = 1)
;   max: 667cc
;   avg: 544.4507883cc   however, deferring to jacobly's result
;   as mine may have math issues ?
;   177 bytes
